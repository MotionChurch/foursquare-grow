...
<@commonpage>
    ...
    <@content class="text">
        ...
        <h2>What is GROW?</h2>
        <p>
            GROW is a comprehensive spiritual formation and discipleship tool
            that is specifically designed to help you grow and mature as a
            follower of Jesus Christ.
        </p>
        <p>
            GROW is an innovative, web based process that incorporates multiple
            media elements for learning including assessments, videos, written
            materials, interactive tools, community forums, etc.
        </p>
        <p>
            GROW is designed to be experienced in a variety of ways to meet all
            the possible scenarios and environments for learning:
        </p>
        <ul>
        ...
        <p>
            We believe that Jesus last command in Matthew 28:19 should be our
            highest priority:
        </p>
        <blockquote>
        ...
        <p>It is in our mission statement:</p>

        <blockquote>
            We present the Gospel message in such a way that Seekers become
            Believers, Believers become Disciples, Disciples become Teachers and
            Teachers lead this process.
        </blockquote>

        <p>And it's our #5 Core value as a church:</p>

        <blockquote>
            We value leadership development. We help Seekers to become
            Believers, Believers to become Disciples and Disciples to become
            Teachers. We want to encourage and cheer the development process.
        </blockquote>

        <p>
            We have created the GROW process for that very purpose, and in
            fulfillment of God's call on the church.
        </p>

        <h2>How does GROW work?</h2>
        ...
        <p>Now it's your turn to act!</p>
        <p>Get started now in your journey by taking the GROW assessment.</p>
